...
from ._optimize import (_minimize_neldermead, _minimize_powell, _minimize_cg,
                        _minimize_bfgs, _minimize_bfgsd, _minimize_bfgsr, _minimize_bfgsz, _minimize_newtoncg,
...
MINIMIZE_METHODS = ['nelder-mead', 'powell', 'cg', 'bfgs', 'bfgsd', 'bfgsr', 'bfgsz', 'newton-cg',
                    'l-bfgs-b', 'tnc', 'cobyla', 'slsqp', 'trust-constr',
                    'dogleg', 'trust-ncg', 'trust-exact', 'trust-krylov']

# These methods support the new callback interface (passed an OptimizeResult)
MINIMIZE_METHODS_NEW_CB = ['nelder-mead', 'powell', 'cg', 'bfgs', 'bfgsd', 'bfgsr', 'bfgsz', 'newton-cg',
    ...
    **Custom minimizers**
    ...
    if callable(jac):
        ...
        jac = fun.derivative
          ...
          meth in ['trust-constr', 'bfgs', 'bfgsd', 'bfgsr', 'bfgsz', 'cg', 'l-bfgs-b', 'tnc', 'slsqp']):
    ...
    if tol is not None:
        ...
        if meth in ('bfgs', 'bfgsd', 'bfgsr', 'bfgsz', 'cg', 'l-bfgs-b', 'tnc', 'dogleg',
    ...
    if meth == 'nelder-mead':
        ...
        res = _minimize_bfgsd(fun, x0, args, jac, callback, **options)
    elif meth == "bfgsr":
        res = _minimize_bfgsr(fun, x0, args, jac, callback, **options)
    elif meth == "bfgsz":
        res = _minimize_bfgsz(fun, x0, args, jac, callback, **options)
    elif meth == 'newton-cg':
