import { t as __require } from "./chunk-DfT7oADQ.js";
...
var qr = ((a) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(a, { get: (r, s) => (typeof __require < "u" ? __require : r)[s] }) : a)(function(a) {
	if (typeof __require < "u") return __require.apply(this, arguments);
	throw Error("Dynamic require of \"" + a + "\" is not supported");
});
var k = (a, r) => () => (a && (r = a(a = 0)), r);
var At = (a, r) => {
	for (var s in r) Hr(a, s, {
		get: r[s],
		enumerable: !0
	});
}, Hf = (a, r, s, f) => {
	if (r && typeof r == "object" || typeof r == "function") for (let i of Vf(r)) !jf.call(a, i) && i !== s && Hr(a, i, {
		get: () => r[i],
		enumerable: !(f = zf(r, i)) || f.enumerable
	});
	return a;
};
var zt = (a) => Hf(Hr({}, "__esModule", { value: !0 }), a);
var Vt, Ze, Ke, qf, Ta, Yr = k(() => {
	"use strict";
	Vt = /* @__PURE__ */ new Map(), Ze = [], Ke = (a, r, s) => {
		if (r && typeof r.init == "function" && typeof r.createInferenceSessionHandler == "function") {
			let f = Vt.get(a);
			if (f === void 0) Vt.set(a, {
				backend: r,
				priority: s
			});
			else {
			...
			if (s >= 0) {
				let i = Ze.indexOf(a);
				i !== -1 && Ze.splice(i, 1);
				for (let d = 0; d < Ze.length; d++) if (Vt.get(Ze[d]).priority <= s) {
					Ze.splice(d, 0, a);
					return;
				}
				Ze.push(a);
	...
	xa = (a, r) => {
		...
		if (f != null) {
			...
			for (let R = 0; R < d; R++) for (let H = 0; H < i; H++) {
				let U = (a.data[g++] - w[0]) * y[0], M = (a.data[v++] - w[1]) * y[1], q = (a.data[S++] - w[2]) * y[2], O = C === -1 ? 255 : (a.data[C++] - w[3]) * y[3];
				f.fillStyle = "rgba(" + U + "," + M + "," + q + "," + O + ")", f.fillRect(H, R, 1, 1);
			}
		...
		if (s != null) {
			...
			let v = 4, S = 0, C = 1, R = 2, H = 3, U = 0, M = g, q = g * 2, O = -1;
			m === "RGBA" ? (U = 0, M = g, q = g * 2, O = g * 3) : m === "RGB" ? (U = 0, M = g, q = g * 2) : m === "RBG" && (U = 0, q = g, M = g * 2), f = s.createImageData(i, d);
			for (let W = 0; W < d * i; S += v, C += v, R += v, H += v, W++) f.data[S] = (a.data[U++] - T[0]) * w[0], f.data[C] = (a.data[M++] - T[1]) * w[1], f.data[R] = (a.data[q++] - T[2]) * w[2], f.data[H] = O === -1 ? 255 : (a.data[O++] - T[3]) * w[3];
		} else throw new Error("Can not access image data");
		return f;
	};
});
var Xr, Ba, Ma, Ca, Ua, Da, Pa = k(() => {
	"use strict";
	jt();
	Xr = (a, r) => {
		...
		let m = r.format !== void 0 ? r.format : "RGBA", y = r.tensorFormat !== void 0 && r.tensorFormat !== void 0 ? r.tensorFormat : "RGB", w = s * f, T = y === "RGBA" ? new Float32Array(w * 4) : new Float32Array(w * 3), g = 4, v = 0, S = 1, C = 2, R = 3, H = 0, U = w, M = w * 2, q = -1;
		m === "RGB" && (g = 3, v = 0, S = 1, C = 2, R = -1), y === "RGBA" ? q = w * 3 : y === "RBG" ? (H = 0, M = w, U = w * 2) : y === "BGR" && (M = 0, U = w, H = w * 2);
		for (let W = 0; W < w; W++, v += g, C += g, S += g, R += g) T[H++] = (a[v] + l[0]) / d[0], T[U++] = (a[S] + l[1]) / d[1], T[M++] = (a[C] + l[2]) / d[2], q !== -1 && R !== -1 && (T[q++] = (a[R] + l[3]) / d[3]);
		return y === "RGBA" ? new le("float32", T, [
			1,
			4,
			s,
			f
		...
		let { width: s, height: f, download: i, dispose: d } = r;
		return new le({
			location: "texture",
			type: "float32",
			texture: a,
...
var ka, Wa, Fa = k(() => {
	...
	ka = (a) => {
		...
		switch (a.location) {
			case "cpu": return new le(a.type, a.data, r);
			case "cpu-pinned": return new le({
				location: "cpu-pinned",
				data: a.data,
				type: a.type,
				dims: r
			});
			case "texture": return new le({
				location: "texture",
				texture: a.texture,
				type: a.type,
				dims: r
			});
			case "gpu-buffer": return new le({
				location: "gpu-buffer",
				gpuBuffer: a.gpuBuffer,
				type: a.type,
				dims: r
			});
			case "ml-tensor": return new le({
				location: "ml-tensor",
				mlTensor: a.mlTensor,
				type: a.type,
				dims: r
			});
			default: throw new Error(`tensorReshape: tensor location ${a.location} is not supported`);
		}
	};
});
var le, jt = k(() => {
...
async function es(a = {}) {
	...
	var g, v, S, C, R, H, U = console.log.bind(console), M = console.error.bind(console), q = U, O = M, W = !1, oe = (e) => e.startsWith("file://");
	function p() {
		...
		let e = function(t) {
			try {
				...
				if (o === "load") {
					...
					}, c == "print" && (q = r[c]), c == "printErr" && (O = r[c]));
					Fe = n.ie, se(), v = n.je, bt(), $t();
				} else if (o === "run") {
					(function(u) {
						var c = (p(), A)[u + 52 >>> 2 >>> 0];
						u = (p(), A)[u + 56 >>> 2 >>> 0], Co(c, c - u), D(c);
					})(n.Nc), Fr(n.Nc, 0, 0, 1, 0, 0), bn(), Ir(n.Nc), ne || (po(), ne = !0);
					try {
						$s(n.ge, n.Wc);
					} catch (u) {
						if (u != "unwind") throw u;
	...
	var X, J, Ue, Q, x, A, _, ae, me, Y, we, re = !1;
	function se() {
		var e = Fe.buffer;
		r.HEAP8 = X = new Int8Array(e), Ue = new Int16Array(e), r.HEAPU8 = J = new Uint8Array(e), Q = new Uint16Array(e), r.HEAP32 = x = new Int32Array(e), r.HEAPU32 = A = new Uint32Array(e), _ = new Float32Array(e), ae = new Float64Array(e), me = new BigInt64Array(e), Y = new BigUint64Array(e);
	}
	function yr() {
		re = !0, i ? H() : ke._b();
	}
	function Te(e) {
		throw O(e = "Aborted(" + e + ")"), W = !0, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), R?.(e), e;
	}
	function qe() {
		return { a: {
			f: zs,
	...
	async function bt() {
		...
		}) : i ? e(new WebAssembly.Instance(v, qe()), v) : (we ??= r.locateFile ? r.locateFile ? r.locateFile("ort-wasm-simd-threaded.asyncify.wasm", T) : T + "ort-wasm-simd-threaded.asyncify.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.asyncify.wasm", import.meta.url).href, t = await async function(o) {
			var u = we;
			if (!g && !oe(u)) try {
	...
	var wn = (e) => new Promise((t) => {
		e.onmessage = (u) => {
			var c = u.data;
			if (u = c.Oc, c.Vc && c.Vc != Ft()) {
				var h = Je[c.Vc];
				h ? h.postMessage(c, c.Yc) : O(`Internal error! Worker sent a message "${u}" to target pthread ${c.Vc}, but that thread no longer exists!`);
			} else u === "checkMailbox" ? Pt() : u === "spawnThread" ? Z(c) : u === "cleanupThread" ? he(() => {
				yn(Je[c.he]);
			}) : u === "loaded" ? (e.loaded = !0, t(e)) : c.target === "setimmediate" ? e.postMessage(c) : u === "uncaughtException" ? e.onerror(c.error) : u === "callHandler" ? r[c.be](...c.args) : u && O(`worker sent an unknown command ${u}`);
		}, e.onerror = (u) => {
	...
	}, Ut = [], Dt = 0, ce = (e) => -9007199254740992 > e || 9007199254740992 < e ? NaN : Number(e);
	function zs(e) {
		var t = new gr(e >>>= 0);
		return (p(), X)[t.Qc + 12 >>> 0] == 0 && (Tn(t, !0), Dt--), vn(t, !1), Ut.push(t), Po(e);
	}
	var ft = 0, Vs = () => {
		N(0, 0);
		var e = Ut.pop();
	...
	var Ys = () => {
		...
		var t = e.Xc;
		throw (p(), X)[e.Qc + 13 >>> 0] == 0 && (Ut.push(e), vn(e, !0), Tn(e, !1), Dt++), zr(t), ft = t;
	};
	function Js(e, t, n) {
		var o = new gr(e >>>= 0);
		throw t >>>= 0, n >>>= 0, (p(), A)[o.Qc + 16 >>> 2 >>> 0] = 0, (p(), A)[o.Qc + 4 >>> 2 >>> 0] = t, (p(), A)[o.Qc + 8 >>> 2 >>> 0] = n, zr(e), Dt++, ft = e;
	}
	var Xs = () => Dt;
	function En(e, t, n, o) {
	...
	function Sn(e, t, n, o) {
		...
		var u = [];
		return i && u.length === 0 ? En(e, t, n, o) : (e = {
			fe: n,
			Nc: e,
			Wc: o,
			Yc: u
		}, i ? (e.Oc = "spawnThread", postMessage(e, u), 0) : Z(e));
	}
	function Qs(e) {
		throw ft ||= e >>> 0, ft;
	}
	...
	}, vr = {}, Er = {}, Ks = {}, dt = class extends Error {
		constructor(e) {
	...
	function De(e, t, n = {}) {
		return function(o, u, c = {}) {
			...
			Er[o] = u, delete Ks[o], vr.hasOwnProperty(o) && (u = vr[o], delete vr[o], u.forEach((b) => b()));
		}(e, t, n);
	}
	var Fn = (e, t, n) => {
		switch (t) {
			case 1: return n ? (o) => (p(), X)[o >>> 0] : (o) => (p(), J)[o >>> 0];
			case 2: return n ? (o) => (p(), Ue)[o >>> 1 >>> 0] : (o) => (p(), Q)[o >>> 1 >>> 0];
			case 4: return n ? (o) => (p(), x)[o >>> 2 >>> 0] : (o) => (p(), A)[o >>> 2 >>> 0];
			case 8: return n ? (o) => (p(), me)[o >>> 3 >>> 0] : (o) => (p(), Y)[o >>> 3 >>> 0];
	...
	function ei(e, t, n, o, u) {
		...
		De(e, {
			name: t,
			Mc: c,
			Sc: (h, b) => (typeof b == "number" && (b = BigInt(b)), b),
			Rc: Fn(t, n, !o),
			Tc: null
		});
	}
	...
	function Ir(e) {
		e >>>= 0, wi || (Atomics.waitAsync((p(), x), e >>> 2, e).value.then(Pt), e += 128, Atomics.store((p(), x), e >>> 2, 1));
	}
	var Pt = () => he(() => {
		var e = Ft();
		e && (Ir(e), Mo());
	...
	function gi(e, t) {
		(e >>>= 0) == t >>> 0 ? setTimeout(Pt) : i ? postMessage({
			Vc: e,
			Oc: "checkMailbox"
		}) : (e = Je[e]) && e.postMessage({ Oc: "checkMailbox" });
	}
	var xr = [];
	function Ti(e, t, n, o, u) {
		for (t >>>= 0, u >>>= 0, xr.length = 0, n = u >>> 3, o = u + o >>> 3; n < o;) {
			var c = (p(), me)[n++ >>> 0] ? (p(), me)[n++ >>> 0] : (p(), ae)[n++ >>> 0];
			xr.push(c);
		}
		return (t ? jr[t] : of[e])(...xr);
	}
	var vi = () => {
		G = 0;
	};
	...
	function Ai(e) {
		var t = (...n) => {
			...
			try {
				...
				W || (Rt.pop(), Me && Ge === 1 && Rt.length === 0 && (Ge = 0, G += 1, _t(ba), typeof Fibers < "u" && Fibers.Be()));
			}
		};
		return jn.set(e, t), t;
	}
	var Ge = 0, Me = null, zn = 0, Rt = [], Lr = /* @__PURE__ */ new Map(), Vn = /* @__PURE__ */ new Map(), jn = /* @__PURE__ */ new Map(), Ii = 0, Or = null, xi = [], Hn = (e) => function(t) {
		if (!W) {
			if (Ge === 0) {
				var n = !1, o = !1;
				t((u = 0) => {
					if (!W && (zn = u, n = !0, o)) {
						Ge = 2, _t(() => wa(Me)), typeof MainLoop < "u" && MainLoop.Xd && MainLoop.resume(), u = !1;
						try {
							var c = function() {
								var E = (p(), x)[Me + 8 >>> 2 >>> 0];
						...
						if (!Me) {
							var b = Or;
							b && (Or = null, (u ? b.reject : b.resolve)(c), h = !0);
						}
						if (u && !h) throw c;
					}
				...
				}(), typeof MainLoop < "u" && MainLoop.Xd && MainLoop.pause(), _t(() => ya(Me)));
			} else Ge === 2 ? (Ge = 0, _t(ga), xe(Me), Me = null, xi.forEach(he)) : Te(`invalid state: ${Ge}`);
			return zn;
		}
	}((t) => {
		e().then(t);
	...
	function Ui(e, t, n) {
		...
		switch (e = c.map((E, I) => {
			...
			case 3:
				b = "";
				break;
			case 1: h.getStringOrSymbol = Nt, b = "toValue(handle)[getStringOrSymbol(methodName)]";
		}
  ...
  ${b}
	...
	function ji(e, t) {
		e = ce(e), t >>>= 0, e = /* @__PURE__ */ new Date(1e3 * e), (p(), x)[t >>> 2 >>> 0] = e.getUTCSeconds(), (p(), x)[t + 4 >>> 2 >>> 0] = e.getUTCMinutes(), (p(), x)[t + 8 >>> 2 >>> 0] = e.getUTCHours(), (p(), x)[t + 12 >>> 2 >>> 0] = e.getUTCDate(), (p(), x)[t + 16 >>> 2 >>> 0] = e.getUTCMonth(), (p(), x)[t + 20 >>> 2 >>> 0] = e.getUTCFullYear() - 1900, (p(), x)[t + 24 >>> 2 >>> 0] = e.getUTCDay(), e = (e.getTime() - Date.UTC(e.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, (p(), x)[t + 28 >>> 2 >>> 0] = e;
	}
	var Yn = (e) => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0), Jn = [
		0,
		31,
		60,
		91,
	...
	function Hi(e, t) {
		e = ce(e), t >>>= 0, e = /* @__PURE__ */ new Date(1e3 * e), (p(), x)[t >>> 2 >>> 0] = e.getSeconds(), (p(), x)[t + 4 >>> 2 >>> 0] = e.getMinutes(), (p(), x)[t + 8 >>> 2 >>> 0] = e.getHours(), (p(), x)[t + 12 >>> 2 >>> 0] = e.getDate(), (p(), x)[t + 16 >>> 2 >>> 0] = e.getMonth(), (p(), x)[t + 20 >>> 2 >>> 0] = e.getFullYear() - 1900, (p(), x)[t + 24 >>> 2 >>> 0] = e.getDay();
	...
	var Tt = {}, Yi = () => performance.timeOrigin + performance.now();
	function Kn(e, t) {
	...
	function yu(e, t, n, o, u, c) {
		...
		G += 1, lt(t, h.requestDevice(e).then((B) => {
			--G, he(() => {
				...
				}, "adapterInfo" in B || (B.adapterInfo = h.info), Wr(t, 1, o, 0);
			});
		}, (B) => {
			--G, he(() => {
	...
	function Iu(e, t, n) {
		...
		t = {
			label: Ne(t + 4),
			code: ""
		}, u === 2 && (t.code = to(o + 8)), e = L(e).createShaderModule(t), de[n >>> 0] = e;
	}
	var xu = (e) => {
	...
	function Ou(e, t, n, o) {
		if (t = ce(t), o >>>= 0, n >>>= 0) {
			var u = {
				featureLevel: lu[(p(), x)[n + 4 >>> 2 >>> 0]],
				powerPreference: pu[(p(), x)[n + 8 >>> 2 >>> 0]],
				forceFallbackAdapter: !!(p(), A)[n + 12 >>> 2 >>> 0]
			};
	...
	function ao(e, t) {
		...
		for (n of oo()) {
			var c = t + o;
			(p(), A)[e + u >>> 2 >>> 0] = c, o += Pe(n, c, Infinity) + 1, u += 4;
		}
		return 0;
	}
	function so(e, t) {
	...
	function co(e, t, n, o) {
		...
		for (var u = 0, c = 0; c < n; c++) {
			...
			for (var E = 0; E < b; E++) {
				...
				F === 0 || F === 10 ? ((I === 1 ? q : O)(xn(j)), j.length = 0) : j.push(F);
			}
			u += b;
		}
	...
	function Ru(e, t) {
		if (e >>>= 0, t >>>= 0) {
			...
			n = {
				label: n,
				timestampWrites: t = (t = (p(), A)[t + 12 >>> 2 >>> 0]) !== 0 ? {
					querySet: L((p(), A)[t + 4 >>> 2 >>> 0]),
					beginningOfPassWriteIndex: (p(), A)[t + 8 >>> 2 >>> 0],
					endOfPassWriteIndex: (p(), A)[t + 12 >>> 2 >>> 0]
				} : void 0
			};
		}
	...
	i || function() {
		...
		maximum: 65536,
		shared: !0
	}), se()), r.wasmBinary && (g = r.wasmBinary), r.stackSave = () => P(), r.stackRestore = (e) => D(e), r.stackAlloc = (e) => Gt(e), r.setValue = function(e, t, n = "i8") {
		switch (n.endsWith("*") && (n = "*"), n) {
			...
			case "*":
				(p(), A)[e >>> 2 >>> 0] = t;
				break;
			default: Te(`invalid type for setValue: ${n}`);
		}
	}, r.getValue = function(e, t = "i8") {
		switch (t.endsWith("*") && (t = "*"), t) {
			case "i1":
			case "i8": return (p(), X)[e >>> 0];
			case "i16": return (p(), Ue)[e >>> 1 >>> 0];
			case "i32": return (p(), x)[e >>> 2 >>> 0];
			case "i64": return (p(), me)[e >>> 3 >>> 0];
			case "float": return (p(), _)[e >>> 2 >>> 0];
			case "double": return (p(), ae)[e >>> 3 >>> 0];
			case "*": return (p(), A)[e >>> 2 >>> 0];
			default: Te(`invalid type for getValue: ${t}`);
		}
	}, r.UTF8ToString = ct, r.stringToUTF8 = Pe, r.lengthBytesUTF8 = _e;
	var lo, po, Pr, Ft, xe, pt, mo, ho, yo, bo, wo, go, To, vo, Eo, So, Ao, _r, Rr, Nr, kr, Et, Wr, Io, Fr, xo, Lo, Oo, Gr, Bo, Mo, $r, N, St, Co, D, Gt, P, Uo, zr, Do, Po, _o, Vr, Ro, No, ko, Wo, Fo, Go, $o, zo, Vo, jo, Ho, qo, Yo, Jo, Xo, Qo, Zo, Ko, ea, ta, ra, na, oa, aa, sa, ia, ua, fa, ca, da, la, pa, ma, ha, ya, ba, wa, ga, ke, of = [
		Ye,
		br,
		En,
		Ln,
		...
		980403: () => typeof wasmOffsetConverter < "u"
	};
	function af(e, t, n, o) {
		var u = P();
		try {
	...
	function $t() {
		if (0 < Oe) ee = $t;
			...
			0 < Oe ? ee = $t : (r.calledRun = !0, W || (yr(), C?.(r)));
		}
	}
...
var as, rn, Zf, ge, ss, tn, Kf, ec, is, tc, ns, us, os, fs, Yt = k(() => {
	"use strict";
	qt();
	as = typeof location > "u" ? void 0 : location.origin, rn = import.meta.url > "file:" && import.meta.url < "file;", Zf = () => {
		if (rn) return new URL(new URL("ort.webgpu.bundle.min.mjs", import.meta.url).href, as).href;
		...
		/*@vite-ignore*/
		a
)).default, ns = (Ka(), zt(Za)).default, us = async () => {
		if (!ge) throw new Error("Failed to load proxy worker: cannot determine the script source URL.");
		if (tn(ge)) return [void 0, ns()];
		let a = await is(ge);
		return [a, ns(a)];
	}, os = (rs(), zt(ts)).default, fs = async (a, r, s, f) => {
		let i = os && !(a || r);
		...
		{
			let d = "ort-wasm-simd-threaded.asyncify.mjs", l = a ?? Kf(d, r), m = s && l && !tn(l, r), y = m ? await is(l) : l ?? ec(d, r);
			return [m ? y : void 0, await tc(y)];
		}
	};
});
var nn, on, nr, cs, rc, nc, oc, Jt, z, je = k(() => {
	"use strict";
	Yt();
	on = !1, nr = !1, cs = !1, rc = () => {
		...
		let i = a.wasmPaths, d = typeof i == "string" ? i : void 0, l = i?.mjs, m = l?.href ?? l, y = i?.wasm, w = y?.href ?? y, T = a.wasmBinary, [g, v] = await fs(m, d, s > 1, !!T || !!w), S = !1, C = [];
...
var ac, sc, ic, Ot, ot, uc, ps, ms = k(() => {
	...
	ac = (a) => {
		switch (a) {
			...
			case "all": return 99;
			default: throw new Error(`unsupported graph optimization level: ${a}`);
		}
	}, sc = (a) => {
		switch (a) {
			case "sequential": return 0;
			case "parallel": return 1;
			default: throw new Error(`unsupported execution mode: ${a}`);
		}
	}, ic = (a) => {
		...
		for (let i of f) {
			...
			switch (d) {
				case "webnn":
					if (d = "WEBNN", Ot(a, "session.disable_quant_qdq", "1", s), Ot(a, "session.disable_qdq_constant_folding", "1", s), typeof i != "string") {
						let v = i?.deviceType;
						v && Ot(a, "deviceType", v, s);
					}
					break;
				case "webgpu":
					{
...
var He, ar, mt, at, Bt, sr, ir, an, st = k(() => {
	"use strict";
	He = (a) => {
		switch (a) {
			case "int8": return 3;
			...
			default: throw new Error(`unsupported data type: ${a}`);
		}
	}, ar = (a) => {
		switch (a) {
			case 3: return "int8";
		...
		switch (a) {
			...
			default: throw new Error(`unsupported type: ${a}`);
		}
	}, Bt = (a) => {
		switch (a) {
			...
			case "error": return 3;
			case "fatal": return 4;
			default: throw new Error(`unsupported logging level: ${a}`);
		}
		...
		switch (a) {
			...
			default: throw new Error(`unsupported data location: ${a}`);
		}
	};
});
var Mt, sn = k(() => {
...
var fc, cc, bs, ws, gs, dc, pe, un = k(() => {
	...
	fc = [
		...
		let s = Bt(a);
		s >= Bt(bs) && cc(s, typeof r == "function" ? r() : r);
	}, pe = (...a) => {
		ws && dc(...a);
	};
});
var vs, cn, Es, lc, Ts, pc, Ss, ur, fr, fn, As, Is = k(() => {
	"use strict";
	st();
	un();
	vs = new Map([
		...
		switch (r) {
			...
			default: throw new Error(`Unsupported data conversion from ${r} to 'int32'`);
		}
	}, Es = (a, r) => {
		if (r === "int32") return a;
		...
		switch (r) {
			...
			default: throw new Error(`Unsupported data conversion from 'int32' to ${r}`);
		}
	}, lc = 1, Ts = () => lc++, pc = new Map([
		["int8", "int32"],
		["uint8", "int32"],
		["uint32", "int32"],
		["int64", "int32"]
		...
		registerTensor(r, s, f, i) {
			let d = this.getMLContext(r), l = Ts(), m = new ur({
				sessionId: r,
				context: d,
				tensor: s,
				dataType: f,
		...
		registerMLConstant(r, s, f, i, d, l, m = !1) {
			...
			switch (d.dataType) {
				...
				case "uint8":
					g = new Uint8Array(T);
					break;
				default: throw new Error(`Unsupported data type: ${d.dataType} in creating WebNN Constant from external data.`);
			}
...
var hc, Xt, Qt, it, yc, Os, xt, Zt, Kt, Bs, er, tr, rr, en = k(() => {
	"use strict";
	Ve();
	ls();
	ms();
	...
	hc = (a, r) => {
		...
		hc(a.wasm.numThreads, Bt(a.logLevel));
	}, Qt = async (a, r) => {
		z().asyncInit?.();
		...
		if (r === "webgpu" && z().webgpuInit((f) => {
			...
			let f = new (Ls(), zt(xs)).WebNNBackend(a);
			z().webnnInit([
				f,
				() => f.reserveTensorId(),
				(i) => f.releaseTensorId(i),
				async (i, d, l, m, y) => f.ensureTensor(i, d, l, m, y),
				(i, d) => {
					f.uploadTensor(i, d);
				},
		...
		try {
			if ([l, y] = await ps(r), r?.externalData && i.mountExternalData) {
				...
				for (let W of r.externalData) {
					...
					O.push(Mt(typeof W == "string" ? W : W.data).then((p) => {
			...
			for (let O of r?.executionProviders ?? []) if ((typeof O == "string" ? O : O.name) === "webnn") {
				if (i.shouldTransferToMLTensor = !1, typeof O != "string") {
					...
					p ? i.currentContext = p : ne ? i.currentContext = await i.webnnCreateMLContext(ne) : i.currentContext = await i.webnnCreateMLContext({
						deviceType: X,
						powerPreference: J
					});
			...
			let q = null;
			return M.some((O) => O === "gpu-buffer" || O === "ml-tensor" || O === "ml-tensor-cpu-output") && (m = i._OrtCreateBinding(d), m === 0 && $("Can't create IO binding."), q = {
				handle: m,
				outputPreferredLocations: M,
				outputPreferredLocationsEncoded: M.map((O) => O === "ml-tensor-cpu-output" ? "ml-tensor" : O).map((O) => an(O))
			}), it.set(d, [
				d,
				w,
				T,
		...
		let w = y[0], T = y[1], g = y[2], v = y[3], S = y[4], C = y[5], R = r.length, H = f.length, U = 0, M = [], q = [], O = [], W = [], oe = [], p = l.stackSave(), ne = l.stackAlloc(R * m), X = l.stackAlloc(R * m), J = l.stackAlloc(H * m), Ue = l.stackAlloc(H * m);
		try {
			[U, M] = ds(d), $e("wasm prepareInputOutputTensor");
			for (let _ = 0; _ < R; _++) await Bs(s[_], q, W, a, T[r[_]], r[_], S);
			...
			if (v && !C) {
				...
				for (let Y = 0; Y < H; Y++) {
					let we = f[Y];
					i[Y]?.[3] ? (oe.push(O[Y]), l._OrtBindOutput(_, g[we], O[Y], 0) !== 0 && $(`Can't bind pre-allocated output[${Y}] for session=${a}.`)) : l._OrtBindOutput(_, g[we], 0, me[we]) !== 0 && $(`Can't bind output[${Y}] to ${ae[Y]} for session=${a}.`);
				}
				ze("wasm bindInputsOutputs"), it.set(a, [
					w,
					T,
					g,
					v,
			...
			for (let _ = 0; _ < H; _++) {
				...
				try {
					...
					if (re === "string") {
						...
						let ee = [];
						for (let Z = 0; Z < Ae; Z++) {
							let G = l.getValue(se + Z * m, "*"), V = l.getValue(se + (Z + 1) * m, "*"), Ye = Z === Ae - 1 ? void 0 : V - G;
						...
						if (!Z(a, re, !1)) throw new Error(`preferredLocation "ml-tensor" for ${re} output is not supported by current WebNN Context.`);
						...
						we = !0, x.push([
							...
							{
								mlTensor: V,
								download: l.webnnCreateMLTensorDownloader(se, re),
								dispose: () => {
						...
						let Z = new (at(re))(Ae);
						new Uint8Array(Z.buffer, Z.byteOffset, Z.byteLength).set(l.HEAPU8.subarray(se, se + Z.byteLength)), x.push([
							re,
							Se,
							Z,
							"cpu"
			...
			v && !S && (l._OrtClearBoundOutputs(v.handle) !== 0 && $("Can't clear bound outputs."), it.set(a, [
				w,
				T,
				g,
				v,
			...
			l.webnnOnRunEnd?.(w), l.stackRestore(p), s.forEach((Q) => {
				...
				Q && Q[3] === "gpu-buffer" && l.webgpuUnregisterBuffer(Q[2].gpuBuffer);
			}), q.forEach((Q) => l._OrtReleaseTensor(Q)), O.forEach((Q) => l._OrtReleaseTensor(Q)), W.forEach((Q) => l._free(Q)), U !== 0 && l._OrtReleaseRunOptions(U), M.forEach((Q) => l._free(Q));
		}
	}, tr = (a) => {
		let r = z(), s = it.get(a);
...
var ut, Ee, Ct, lr, pr, dr, ln, pn, ht, yt, wc, Ms, Cs, Us, Ds, Ps, _s, Rs, mn = k(() => {
	"use strict";
	Ve();
	en();
	je();
	Yt();
	ut = () => !!K.wasm.proxy && typeof document < "u", Ct = !1, lr = !1, pr = !1, pn = /* @__PURE__ */ new Map(), ht = (a, r) => {
		let s = pn.get(a);
		s ? s.push(r) : pn.set(a, [r]);
	}, yt = () => {
		if (Ct || !lr || pr || !Ee) throw new Error("worker not ready");
	}, wc = (a) => {
		switch (a.data.type) {
			case "init-wasm":
				Ct = !1, a.data.err ? (pr = !0, ln[1](a.data.err)) : (lr = !0, ln[0]()), dr && (URL.revokeObjectURL(dr), dr = void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!lr) {
			...
			if (Ct = !0, ut()) return new Promise((a, r) => {
				Ee?.terminate(), us().then(([s, f]) => {
					try {
						...
						!i.in.wasm.wasmPaths && (s || rn) && (i.in.wasm.wasmPaths = { wasm: new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.asyncify.wasm", import.meta.url).href }), Ee.postMessage(i), dr = s;
					} catch (i) {
						r(i);
					}
				}, r);
			...
			try {
				await Jt(K.wasm), await Xt(K), lr = !0;
			} catch (a) {
				throw pr = !0, a;
			} finally {
				Ct = !1;
...
var Ns, gc, mr, ks = k(() => {
	...
	Ns = (a, r) => {
		switch (a.location) {
			...
			default: throw new Error(`invalid data location: ${a.location} for ${r()}`);
		}
	}, gc = (a) => {
		switch (a[3]) {
			case "cpu": return new Le(a[0], a[2], a[1]);
			case "gpu-buffer": {
				let r = a[0];
			...
			default: throw new Error(`invalid data location: ${a[3]}`);
		}
	}, mr = class {
		async fetchModelAndCopyToWasmMemory(r) {
			return Us(await Mt(r));
		}
		async loadModel(r, s) {
			tt();
			let f;
...
var Ws, hr, Tc, Gs = k(() => {
	...
	Ws = () => {
		...
		let a = K.wasm.simd;
		if (typeof a != "boolean" && a !== void 0 && a !== "fixed" && a !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${a}". Reset it to \`false\` and ignore SIMD feature checking.`), K.wasm.simd = !1), typeof K.wasm.proxy != "boolean" && (K.wasm.proxy = !1), typeof K.wasm.trace != "boolean" && (K.wasm.trace = !1), typeof K.wasm.numThreads != "number" || !Number.isInteger(K.wasm.numThreads) || K.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) K.wasm.numThreads = 1;
		else {
...
//#endregion
export { Yf as InferenceSession, Ga as TRACE, $e as TRACE_EVENT_BEGIN, ze as TRACE_EVENT_END, tt as TRACE_FUNC_BEGIN, rt as TRACE_FUNC_END, Le as Tensor, gl as default, K as env, Ke as registerBackend };
